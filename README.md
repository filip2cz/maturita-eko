...
- Je širší kategorie a spadají pod ní:
	- živnostníci
	- podnikatelé na základě jiných než živnostenských oprávnění - např. lékaři, advokáti, zemědělci
	- osoby vykonávající svobodná povolání
- Ručí celým svým majetkem
- Na rozdíl od ostatních podniků, resp. právnických osob nepladí daň z příjmu právnických osob
- **Nemá společenskou smlouvu**

#### Statní podniky
- Vlastněny státem, ale stát neposkytuje pomoc, co by porušila zákon o hospodářské soutěži
- IČO, obchodní rejstřík
- Například Česká pošta, Lesy ČR, České dráhy
...
#### Družstva
- Převážně za účelem podpoření svých členů nebo třetích osob, může i podnikat
- **Minimálně 3 členové**
- Existují také bytová a sociální družstva
- Odlišnost družstev od obchodních společností spočívá např. v možnosti nabývat členství beze změny zakladatelského dokumentu

### Poznámky
- Založení x Vznik
	- Založení - uzavření společenské smlouvy
	- Vznik - vepsání do obchodního rejstříku
...
- **Ohlašovací**
	- Nárokovaná
	- Stát musí povolit podnik při splnění podmínek, nemůže zamítnout
	- Typy
		- Volné (nákup a prodej zboží)
		- Řemeslné - povinná kvalifikace, možný odborný záztup (truhlář, zámečník)
		- Vázané - vyšší kvalifikace (oční optika, lékárny)
- **Koncesované**
	- Stát může koncesi odepřít
	- Ilegální provozovat aktivity bez koncese
	- Nutná občanská bezúhonnost
	- Beznárokové
	- Pohřební služba, prodej zbraní, autoškola
- **Ostatní OSVČ**
	- Malá nebo vysoká kvalifikace
	- Např. pronájem
...
- Plnoletost
- České občanství nebo trvalé bydliště na území v ČR
...
- Volba oboru (podle zájmu, znalost)
- Průzkum trhu (už v oboru, info o konkurenci, kupní síla obyvatel, tržní segment)
- Plán realizace (peníze - způsob financování, prostory - eshop/kamenná prodejna, technické zázemí, administrace)
- Zakladatelský rozpočet (kalkulace nákladů, mzdy, el. energie, pojištění, internet, nájem)
- Posouzení reálnosti
- Založení podniku (osoba fyzická nebo právnická)

### Příklady
- Zprostředkování obchodu a služeb - volná živnost
- Reklamní činnost, marketing - volná živnost
- Zednictví - řemeslná živnost
- Kadeřnictví - řemeslná živnost

---
## 13. Obchodní zákoník a obchodní rejstřík

### Obchodní zákoník
- Zákoník, který upravuje postavení podnikatelů, obchodní závazkové vztahy
- Zákoník stanovuje:
	- postavení podnikatelů - např. otázky obchodní společnosti, firmy, jednání podnikatele
	- obchodní závazkové vztahy - např. obchodní smlouvy, odpovědnost za škodu
...
- https://www.zakonyprolidi.cz/cs/1991-513

### Obchodní rejstřík
- Veřejný registr, ve kterém jsou zapsané obchodní společnosti, podnikatelé a další
- Jsou tam zapsány tyto subjekty:
	- všechny **právnické osoby**, tedy obchodní společnosti a družstva
	- některé **f. osoby (podnikatélé)**, které přesáhly 120 milionů příjmů za poslední dvě účetní období
	- některé **zahraniční podnikající osoby**
	- **další podnikatelé**, kterým tuto povinnost stanoví právní předpis nebo o to samy požádají
- Vede jej **rejstříkový soud** pod ministerstvem spravedlnosti, je jen jeden rejstřík, ale několik soudů provádí úpravy
- Je vedený online a všichni k němu mají přistup
- Obsahuje například
	- Jméno a adresa zapsané osoby
	- Předmět činnosti nebo podnikání
	- Právní forma p. osoby
	- den vzniku a zániku p. osoby
	- V případě f. osoby
		- Datum narození
		- Adresa místa pobytu
	...
	- *A další podle druhu obchodní korporace (S.R.O., A.S.)*
- Postup zápisu do obchodního rejstříku, jsou dva způsoby
	- Přes soud
		1. U obchodních společností je nejdříve potřeba sepsat společenskou smlouvu a u s.r.o. i ověřit notářem
		2. Poté vyplnit "inteligentní" formulář na stránkách ministerstva
			- https://or.justice.cz/ias/ui/podani
		3. Zaslat ho poštou rejstříkovému soudu
			- Podat návrh může jen osoba k tomu oprávněná
			- V ob. rejstříku se objeví zápis, pokud je schválený, do 5 pracovních dnů zpravidla
	- Přes notáře - přímý zápis
		- Notáři také za určitých podmínek mohou zapisovat do obchodního rejstříku
		- Samy si za to účtují poplatek, ale ve finále bývá menší než u soudu
		- Zápis bude v ob, rejstříku už druhý den
- https://or.justice.cz/ias/ui/rejstrik

### Poznámky
- Do obchodního rejstříků nemusí být zapsáni všichni OSVČ, ale v **živnostenském rejstříku** musí být všichni s živnostenským oprávněním

---
## 14. Obchodní společnosti
- Společenská smlouva, až po ní se žádá o zápis do obchodního rejstříku
	- Jak se bude dělit zisk
	- Jak se každý bude chovat
	- Co se bude dít při odchodu majitelů/společníků
	- ...

### Osobní
- Ručí celým svým osobním majetkem
- Vklad není povinný
- Osobní účast majitelů
- **V.O.S.**
	- Alespoň dva společníci
	- Vhodné pro malé a rodinné podniky, ale dnes se už moc nezakládá, kvůli velikým rizikům
	- Společenská smlouva
		- V případě úmrtí bude rodina zesnulého majitele/společníka **finančně** odškodněna
- **Komanditní společnost**
	- Rozdělení zisku
		- Bez úprav společenskou smlouvou se dělí tímto způsobem
			- jedna polovina - dělí se rovnoměrně mezi komplementáře
			- druhá polovina - připadá na podnik, podle vkladu se děli mezi komanditisty
	- 2 typy společníků
		- Komplementář
			- Podobný společníku jako ve V.O.S
			- Ručí celým svým majetkem
			- **Nemá povinný vklad (je povolený)**
			- Firmu řídí, vede a rozhoduje
			- Může jich být několik, ale minimálně jeden
		- Komanditista
			- Ručí jenom vkladem
			- **Vklad má povinný (teď minimálně 5000kč)**
			- Má právo pouze na informace, nevede a neřídí
			- Může jich být několik, ale minimálně jeden
	- Hodí se na rozdělení pravomoci řídící a má pevně daná rizika, také má malé náklady na založení
	- Komplementář nemá povinný vklad a tak je méně nároková pro něj
	- Příklady kom. společností
		- Glóbus ČR, k. s.
		- Bauhaus, k. s.
...
- Vklad je povinný
- **S.R.O**
	- **Právnická osoba, zapsaná v obchodním rejstříku, obchodní společnost, kapitálový typ**
	- Je potřeba 1 až 50 společníků
	- Nejčastější druh obchodní společnosti v ČR, kvůli malým nárokům a omezenému riziku
	- **Minimální vklad dnes 1kč (do roku 2014 200,000kč)**
		- Tímto a dalšími změnami se zjednodušuje S.R.O. několika společníků
	- Společenská smlouva
		- Váha hlasu společníka
		- Rozdělení zisku
		- *je potřeba ji ověřit u notáře*
	- Valná hromada
		- **pouze pokud počet společníků > 1**
		- povinný meeting alespoň jednou za jedno daňové období (jeden rok)
		- hlasuje se o jednateli (velmi často zakladatel, jednatel není zaměstnanec, lze ho odvolat ze dne na den)
		- dozorčí rada - nepovinná, kontroluje jednatele pro VH
		- rozdělení zisku, i podle společenské smlouvy
		- váha hlasu společníka podle společenské smlouvy, nejčastěji podle vkladu
- **A.S**
	- Minimálně jeden společník
	- Akcie - druh cenného papíru, vyjadřuje podíl na podniku
		- Nominální hodnota - zapsána na akcii jako takové
		- Reálná - za kolik lze akcii koupit
		- Zlatá akcie - právo veta i při minoritním podílu
	- Valná hromada
		- Volí a odvolává představenstvo
			- minimálně 3 členové, kde jeden je předseda
			- stanovy mohou povolit dozorčí radě odvolat představenstvo
		- Dozorčí rada - povinná, kontroluje představenstvo pro valnou hromadu
		- Dividenda - podíl na zisku připadající na jednu akcii
		- hlasuje se o jednateli (velmi často zakladatel, jednatel není zaměstnanec, lze ho odvolat ze dne na den)
		- povinný meeting alespoň jednou za jedno daňové období (jeden rok)
	- Zisk jde na
		- Dividendy
		- Investice
		- Rezervy
	- Ručí se vkladem (minimální 2 000 000kč) a akciemi
...
- Daňový poplatník - snížení majetku nebo příjmu o daň, stát ho ne vždy musí znát
	- Ten, kdo schudne o placenou daň, u DPH zákazník
- Daňový objekt - předmět zdanění (prodané zboží)
- Daňová sazba - vyjádření hodnoty daně, například v % nebo pevné částce
- Daňová lhůta - konkrétní termín nebo perioda
...
- Přímé - stát zná plátce i poplatníka
	- Silniční daň, daň z nemovitých věcí, daň z příjmu p. osob, daň z příjmu f. osob
- Nepřímé - stát zná adresně plátce, ale poplatníka ne
	- DPH, Spotřební daň, ekologické daně

---
### (11-15) Zdroje
- https://www.profispolecnosti.cz/cs/ostatni-rady-a-zkusenosti/k-zalozeni-nove-s-r-o-vam-bude-stacit-jiz-jen-jedna-koruna/a-1580/
- https://www.nkcr.cz/sluzby/pravnicke-osoby-a-podnikani/valna-hromada
- https://www.finance.cz/518889-pravni-formy-podnikani/#firmy1
- https://cs.wikipedia.org/wiki/Obchodn%C3%AD_z%C3%A1kon%C3%ADk
